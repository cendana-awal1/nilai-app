...
import { Edit2, Trash2, Search, ChevronLeft, ChevronRight, Download } from 'lucide-react';
  ...
  const handleDownloadExcel = () => {
    try {
      const worksheet = XLSX.utils.json_to_sheet(
        filteredAssessments.map(({ id, ...rest }) => ({
          ...rest,
      ...
      XLSX.writeFile(workbook, 'student-assessments.xlsx');
      ...
      <div className="bg-white rounded-lg shadow p-4">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            ...
            disabled={!pb.authStore.isValid || filteredAssessments.length === 0}
